        ...
        <div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
            ...
            <form id="categoryForm" class="p-6">
                ...
                <div class="mb-6">
                    ...
                    <span id="preview" class="inline-block px-4 py-2 rounded"
                          style="background: {{ $category->backgroundColor }}; color: {{ $category->textColor }};">
                    {{ $category->name }}
                </span>
                </div>
                ...
                <div class="flex gap-2">
                    ...
                    <a href="{{ route('admin.categories.index') }}"
                       class="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50">
                        Cancel
                    </a>
                </div>
            </form>
