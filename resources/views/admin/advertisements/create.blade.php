    ...
    <div class="w-full px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8">
            <div class="flex items-center gap-4 mb-4">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Create Advertisement</h1>
                    <p class="mt-1 text-sm text-gray-700 dark:text-gray-400">Add a new advertisement to your site</p>
                </div>
            </div>
        </div>
        ...
        <!-- Form -->
        <form action="{{ route('admin.advertisements.store') }}" method="POST" id="ad-form" class="space-y-6">
            @csrf
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 space-y-6">
                ...
                <div class="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-6 bg-gray-50 dark:bg-gray-700/50">
                    ...
                    <div id="current-image" class="mb-6 hidden">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <select name="position"
                            ...
                            <option value="sidebar" {{ old('position', 'sidebar') === 'sidebar' ? 'selected' : '' }}>Sidebar</option>
                    ...
                    <div>
                        ...
                        <select name="size"
                            ...
                            <option value="banner" {{ old('size') === 'banner' ? 'selected' : '' }}>Banner</option>
                        </select>
                        @error('size')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
            ...
            <div class="flex items-center justify-end gap-4">
                ...
                <button type="submit"
                    ...
                    <i class="fa-solid fa-save mr-2"></i>Create Advertisement
                </button>
            </div>
        </form>
    </div>
        ...
        <script>
            (function() {
                ...
                window.addEventListener('beforeunload', function(e) {
                    if (hasUnsavedChanges && currentImagePath && currentImagePath.startsWith('/images/')) {
                ...
                function handleRemoveImage() {
                    ...
                    if (currentImagePath.startsWith('/images/')) {
                        deleteImage(currentImagePath);
                    }
