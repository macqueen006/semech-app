<x-auth-layout>
    <main class="flex h-screen w-full items-center py-12">
                ...
                <div class="p-4 sm:p-7">
                    <div class="text-center">
                        ...
                        <p class="mt-2 text-sm text-center text-muted-foreground-2">
                            ...
                            <a class="text-secondary decoration-2 hover:underline focus:outline-hidden focus:underline font-medium"
                               href="{{route('register')}}">
                                Sign up here
                            </a>
                        </p>
                    ...
                    <div class="mt-5">
                        <a class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg bg-layer border border-gray-200 text-layer-foreground shadow-2xs hover:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none focus:outline-hidden focus:bg-layer-focus"
                           href="#">
                    ...
                    <div
                        class="py-3 flex items-center text-xs text-gray-400 uppercase before:flex-1 before:border-t before:border-line-2 before:me-6 after:flex-1 after:border-t after:border-line-2 after:ms-6">
                        Or
                    </div>
                    @if (session('status'))
                        <x-alert type="success" title="Success!" class="mt-5">
                            {{ session('status') }}
                        </x-alert>
                    @endif
