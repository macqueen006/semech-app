        ...
        <div class="max-w-md mx-auto p-6 w-full">
            <div class="border border-gray-200 rounded-xl shadow-2xs">
                <div class="p-4 sm:p-7">
                    ...
                    <div class="py-3 flex items-center text-xs text-gray-400 uppercase before:flex-1 before:border-t before:border-line-2 before:me-6 after:flex-1 after:border-t after:border-line-2 after:ms-6">
                        Or
                    </div>
